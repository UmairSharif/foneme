...
class SocialLinksViewController: FMBaseViewController,
    ...
    override func viewDidLoad() {
        ...
        lbCopyLink.text = "https://fone.me/\(user.cnic!)"
        ...
        viewLink.layer.borderColor = hexStringToUIColor(hex: "E8E8E8").cgColor
        viewLink.layer.borderWidth = 1.0
        viewLink.layer.cornerRadius = 12.0
        viewLink.backgroundColor = .clear
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        if let userProfileData = UserDefaults.standard.object(forKey: key_User_Profile) as? Data,
            ...
            if user.userId == me.userId {
                ...
                vManageLinksHeightConstraint.constant = 50
