...
class GroupChannelSettingsViewController: UIViewController, UITableViewDelegate, UITableViewDataSource, GroupChannelInviteMemberDelegate, GroupChannelSettingsTableViewCellDelegate, GroupChannelCoverImageNameSettingDelegate, NotificationDelegate, SBDChannelDelegate {
    ...
    @IBOutlet weak var adminBottomLine: UIView!
    @IBOutlet weak var membersBtn: UIButton!
    @IBOutlet weak var membersBottomLine: UIView!
...
//        GroupChannelInviteMemberViewController {
//            destination.channel = self.channel
//            destination.delegate = self
        
//        let storyboard: UIStoryboard = UIStoryboard.init(name: "GroupChannel", bundle: nil)
//        let vc: GroupChannelInviteMemberViewController = storyboard.instantiateViewController(withIdentifier: "")
    }
    
    @IBAction func editGroup(_ sender: UIButton) {
//        GroupChannelCoverImageNameSettingViewController {
//            destination.channel = self.channel
//            destination.delegate = self
    }
    ...
    @IBAction func muteNotification(_ sender: UIButton) {
        ...
        let pushOption: SBDGroupChannelPushTriggerOption = true ? .all : .off
    ...
    func inviteBtnTapped() {
        if let val = self.groupInfoDic["DeepLink"] as? String {
            if let link1 = NSURL(string: val) {
    ...
    @IBAction func adminsAction(_ sender: UIButton) {
        adminBottomLine.backgroundColor = hexStringToUIColor(hex: "3E79ED")
        adminBtn.setTitleColor(hexStringToUIColor(hex: "3E79ED"), for: .normal)
        
        membersBtn.setTitleColor(.lightGray, for: .normal)
        membersBottomLine.backgroundColor = .clear
    }
    
    @IBAction func membersAction(_ sender: UIButton) {
        adminBottomLine.backgroundColor = .clear
        adminBtn.setTitleColor(.lightGray, for: .normal)
        
        membersBtn.setTitleColor(hexStringToUIColor(hex: "3E79ED"), for: .normal)
        membersBottomLine.backgroundColor = hexStringToUIColor(hex: "3E79ED")
    }
