...
struct KeychainItem {
    ...
    static var currentUserIdentifier: String {
        do {
            let storedIdentifier = try KeychainItem(service: "com.mjlob.app", account: "userIdentifier").readItem()
            
            let JSONData = storedIdentifier.data(using: .utf8)!
    ...
    static func deleteUserIdentifierFromKeychain() {
        do {
            try KeychainItem(service: "com.mjlob.app", account: "userIdentifier").deleteItem()
        } catch {
            print("Unable to delete userIdentifier from keychain")
        }
    }
    
    func saveItemUserData(_ userInfo: [String: String]) throws {
          ...
          if let jsonData = try? encoder.encode(userInfo) {
              if let jsonString = String(data: jsonData, encoding: .utf8) {
                  ...
                  // Encode the password into an Data object.
                  let encodedPassword = jsonString.data(using: String.Encoding.utf8)!
