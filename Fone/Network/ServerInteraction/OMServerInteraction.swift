...
class ServerCall {
    ...
    class func makeCallWithFile(_ url: String, params: [String:Any]?, files: [String:OMFile]?, type:Method, currentView: UIView?, header:[String:String],completionHandler: @escaping (_ response: JSON?) -> ()) {
        ...
        APIManager.sharedManager.request(completeUrl, method: convertType(type), parameters: params, encoding: type != .GET ? JSONEncoding.default : URLEncoding.default  , headers: header)
    ...
    class func makeCallWithMultipleFile(_ url: String, params: [String:Any]?, files: [[String:OMFile]]?, type:Method, currentView: UIView?, header:[String:String],completionHandler: @escaping (_ response: JSON?) -> ()) {
        ...
        if let files = files {
            ...
            uploadMultipleFiles(url, params: params, files: files, currentView: currentView, header: header, completionHandler: { (response) -> () in
                completionHandler(response)
            })
            return
        }
    ...
    fileprivate class func uploadMultipleFiles(_ url: String, params: [String:Any]?, files: [[String: OMFile]], currentView: UIView?,header:[String:String],completionHandler: @escaping (_ response: JSON?) -> ()) {
        var completeUrl = url
        if url.range(of: "http:") != nil {
            completeUrl = url
        }
