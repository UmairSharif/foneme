//
//  AudioCallHandler.swift
//  Fone
//
//  Created by Bester on 26/02/2020.
...
class AudioCallHandler: NSObject {
    ...
    weak var roomTextField: UITextField!
    weak var disconnectButton: UIButton!
    weak var speakerButton: UIButton!
    weak var statusLbl: UILabel!
    weak var timerLbl : UILabel!
    weak var callerImage: UIImageView!
    ...
    static let instance = AudioCallHandler()
...
extension AudioCallHandler : TVIRoomDelegate {
...
extension AudioCallHandler : TVIRemoteParticipantDelegate {
...
extension AudioCallHandler : TVIVideoViewDelegate {
...
extension AudioCallHandler : TVICameraCapturerDelegate {
    func cameraCapturer(_ capturer: TVICameraCapturer, didStartWith source: TVICameraCaptureSource) {
        self.previewView.shouldMirror = (source == .frontCamera)
    }
}

extension AudioCallHandler
{
    func addCallLogAPI()
    {
    ...
    func recevierSendNotificationAPI(){
        ...
        ServerCall.makeCallWitoutFile(endCallUrl, params: parameter, type:Method.POST, currentView: nil, header: headers) { (response) in
    ...
    func dialerSendNotificationAPI(){
        ...
        let parameter = [
            "SenderMobileNumber" : NotificationHandler.shared.dialerNumber ?? "",
            "NotificationType" : "CE",
            "ReceiverUserId" : NotificationHandler.shared.receiverId ?? ""
            ] as [String : Any]
        print(parameter)
