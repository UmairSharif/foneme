...
extension UIImageView {
    ...
    func setProfileImageView(for user: SBDUser) {
        ...
        if let coverUrl = user.profileUrl, !coverUrl.hasPrefix("https://static.sendbird.com/sample/user_sdk"){
...
class ProfileImageView: UIView {
    ...
    func setImage(withCoverUrl coverUrl: String){
        ...
        if let url = URL(string: coverUrl){
            imageView.af_setImage(withURL: url, placeholderImage: UIImage(named: "ic_profile"))
        }
        else {
